...
Then, navigate to <a href="http://localhost:4200/remote" target="_blank">http://localhost:4200/remote</a> in your browser to see the home page from your remote application.
...
<a href="https://github.com/soumyanildas/nx-rspack-host" target="_blank">GitHub - soumyanildas/nx-rspack-host</a><br />
